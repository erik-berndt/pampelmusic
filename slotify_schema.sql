...
CREATE TABLE `albums` (
  ...
  `artworkPath` varchar(250) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `songs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22993 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-02-09 19:03:21
